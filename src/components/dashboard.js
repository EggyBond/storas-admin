                            ...
                            <div className="card o-hidden widget-cards">
                                <div className="bg-warning card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Pemasukan</span>
                                            <h3 className="mb-0">Rp. <CountUp className="counter" end={2000000} /><small> Bulan Ini</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card o-hidden  widget-cards">
                                <div className="bg-secondary card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Jumlah Warehouse</span>
                                            <h3 className="mb-0"><CountUp className="counter" end={2} /> Unit<small></small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card o-hidden widget-cards">
                                <div className="bg-primary card-body">
                                    <div className="media static-top-widget row">
                                        ...
                                        <div className="media-body col-8"><span className="m-0">Pesanan</span>
                                            <h3 className="mb-0"><CountUp className="counter" end={10} /><small> Bulan Ini</small></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
